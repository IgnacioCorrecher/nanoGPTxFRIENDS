...
# Hyperparameters
context_length = 256 # How much are we feeding the transformer at the same time, also known as block size. In this case 8 numbers
...
open('data/output.txt', 'w').write(decode(m.generate(context, max_new_tokens=10000)[0].tolist()))